...
<head>
    ...
    <link href="template_admin/demo1/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
    <link href="template_admin/demo1/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('template_admin/demo1/assets/media/auth/bg4.jpg');
            }

            [data-bs-theme="dark"] body {
                background-image: url('template_admin/demo1/assets/media/auth/bg4-dark.jpg');
            }
        </style>
        <!--end::Page bg image-->
                ...
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="form w-100" novalidate="novalidate"
                            id="kt_sign_in_form" data-kt-redirect-url="index.html">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Azzamil School</div>
                                <!--end::Subtitle=-->
                            </div>
