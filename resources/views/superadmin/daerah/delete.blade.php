...
<div class="modal fade" id="modal_delete_daerah_{{ $daerah->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-500px">
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header">
                <h2 class="fw-bold">Hapus Daerah</h2>
            ...
            <div class="modal-body px-5 my-7">
                <div class="text-center mb-5">
                    ...
                    <div class="text-muted fw-semibold fs-6">
                        Data daerah <span class="fw-bold">{{ $daerah->nama_daerah }}</span> akan dihapus permanen.
                    </div>
                </div>
