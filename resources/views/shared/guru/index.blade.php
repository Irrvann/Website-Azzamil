...
@section('content')
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal_add_guru">
                                    <i class="ki-duotone ki-plus fs-2"></i>Tambah Guru</button>
                                <!--end::Add user-->
                            </div>
                            <!--begin::Modal - Add task-->
                            @include('shared.guru.create')
                            <!--end::Modal - Add task-->
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    @foreach ($dataGuru as $index => $guru)
                                        <tr>
                                            ...
                                            <td>{{ $guru->tanggal_lahir ? \Carbon\Carbon::parse($guru->tanggal_lahir)->format('d-m-Y') : '-' }}
                                            </td>
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#modal_detail_guru_{{ $guru->id }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#modal_edit_guru_{{ $guru->id }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                            data-bs-target="#modal_delete_guru_{{ $guru->id }}">
                                                            Delete
                                                        </a>
                                        ...
                                        @include('shared.guru.detail')
                                        <!--end::Modal - Detail task-->
                                        <!--begin::Modal - Edit task-->
                                        @include('shared.guru.edit')
                                        <!--end::Modal - Edit task-->
                                        <!--begin::Modal - Delete task-->
                                        @include('shared.guru.delete')
                                        <!--end::Modal - Delete task-->
                                    @endforeach
                                    {{-- Baris "Tidak ada data" --}}
                                    <tr id="row-no-data" @if (count($dataGuru)) style="display: none" @endif>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const searchInput = document.querySelector('[data-guru-table-filter="search"]');
            const table = document.getElementById('tabel_guru');
