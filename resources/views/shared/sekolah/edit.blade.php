        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                ...
                <form id="modal_edit_sekolah_form" class="form form-loading"
                    action="{{ route('admin.sekolah.update', $sekolah->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_edit_sekolah_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                ...
                                <option value="baby" {{ old('jenis_sekolah', $sekolah->jenis_sekolah) == 'baby' ? 'selected' : '' }}>Baby</option>
                                <option value="toddler" {{ old('jenis_sekolah', $sekolah->jenis_sekolah) == 'toddler' ? 'selected' : '' }}>Toddler</option>
                                <option value="pra_kb" {{ old('jenis_sekolah', $sekolah->jenis_sekolah) == 'pra_kb' ? 'selected' : '' }}>Pra KB</option>
                                <option value="kb_kecil" {{ old('jenis_sekolah', $sekolah->jenis_sekolah) == 'kb_kecil' ? 'selected' : '' }}>KB Kecil</option>
                                <option value="kb_besar" {{ old('jenis_sekolah', $sekolah->jenis_sekolah) == 'kb_besar' ? 'selected' : '' }}>KB Besar</option>
