...
<div class="modal fade" id="modal_add_sekolah" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="modal_add_sekolah_header">
                <!--begin::Modal title-->
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form  id="modal_add_sekolah_form" class="form form-loading"
                    action="{{ route('admin.sekolah.store') }}" method="POST">
                    @csrf
                    <input type="hidden" name="form_source" value="add_sekolah">
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_add_sekolah_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto"
                        data-kt-scroll-dependencies="#modal_add_sekolah_header"
                        data-kt-scroll-wrappers="#modal_add_sekolah_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
...
<!--end::Modal - Add task-->
@if ($errors->any() && old('form_source') === 'add_sekolah')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var myModal = new bootstrap.Modal(document.getElementById('modal_add_sekolah'));
            myModal.show();
        });
    </script>
@endif
