                        ...
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_add_anak_scroll"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nik"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NIK anak"
                                    value="{{ old('nik') }}" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nisn"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NISN anak"
                                    value="{{ old('nisn') }}" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nipd"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NIPD anak"
                                    value="{{ old('nipd') }}" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="no_kk"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NO KK anak"
                                    value="{{ old('no_kk') }}" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="no_registrasi_akta"
                                    ...
                                    placeholder="No Registrasi Akta anak" value="{{ old('no_registrasi_akta') }}" />
                            ...
                            <div class="fv-row mb-7">
                                <label class="fw-semibold fs-6 mb-2">Nama<span
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="tempat_lahir"
                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="Tempat Lahir anak" value="{{ old('tempat_lahir') }}" />
                                @if (old('form_source') == 'add_anak')
                                    @error('tempat_lahir')
                                        <div class="text-danger mt-2">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <input class="form-control form-control-solid ps-12"
                                        placeholder="Tanggal Lahir anak" type="date" name="tanggal_lahir"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12"
                                        placeholder="Tanggal Masuk anak" type="date" name="tanggal_masuk"
