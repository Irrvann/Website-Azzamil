...
@section('content')
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal_add_orangtua">
                                    <i class="ki-duotone ki-plus fs-2"></i>Tambah Orang Tua</button>
                                <!--end::Add user-->
                            </div>
                            <!--begin::Modal - Add task-->
                            @include('shared.orangtua.create')
                            <!--end::Modal - Add task-->
                            ...
                            <table class="table align-middle table-row-dashed table-field-colored fs-6 gy-5"
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    @foreach ($dataOrangtua as $index => $orangTua)
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#modal_detail_orangtua_{{ $orangTua->id }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#modal_edit_orangtua_{{ $orangTua->id }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                            data-bs-target="#modal_delete_orangtua_{{ $orangTua->id }}">
                                                            Delete
                                                        </a>
                                        ...
                                        @include('shared.orangtua.detail')
                                        <!--end::Modal - Detail task-->
                                        <!--begin::Modal - Edit task-->
                                        @include('shared.orangtua.edit')
                                        <!--end::Modal - Edit task-->
                                        <!--begin::Modal - Delete task-->
                                        @include('shared.orangtua.delete')
                                        <!--end::Modal - Delete task-->
                                    @endforeach
                                    {{-- Baris "Tidak ada data" --}}
                                    <tr id="row-no-data" @if (count($dataOrangtua)) style="display: none" @endif>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const searchInput = document.querySelector('[data-orangtua-table-filter="search"]');
            const table = document.getElementById('tabel_orangtua');
