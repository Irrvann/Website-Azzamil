            ...
            <div class="mx-auto max-w-6xl px-5 py-10">
                <div class="grid gap-8 md:grid-cols-3">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-xs leading-relaxed text-[#333]">
                            <a href="https://facebook.com/groups/770819614077333/" target="_blank"
                                class="inline-flex items-center gap-1 hover:text-tealBtn transition">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                                FB: Keluarga Azzamil School
                            </a> <br />
                            <a href="https://www.instagram.com/azzamilschool?igsh=Nmd5a3VsY3A3c2dx" target="_blank"
                                class="inline-flex items-center gap-1 hover:text-tealBtn transition">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.117.63c-.79.297-1.427.645-2.058 1.276-.63.63-.979 1.268-1.276 2.058-.297.79-.5 1.659-.56 2.948C.031 8.333 0 8.74 0 12c0 3.26.015 3.667.072 4.947.06 1.277.261 2.148.558 2.913.297.788.645 1.426 1.276 2.058.63.63 1.268.978 2.058 1.276.765.297 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24c3.26 0 3.667-.015 4.947-.072 1.277-.059 2.148-.261 2.913-.558.788-.298 1.426-.646 2.058-1.276.63-.63.979-1.268 1.276-2.058.297-.765.499-1.636.558-2.913.037-1.28.073-1.689.073-4.948 0-3.259-.015-3.667-.072-4.947-.06-1.277-.261-2.148-.558-2.913-.297-.789-.645-1.427-1.276-2.058-.63-.63-1.268-.979-2.058-1.276-.765-.297-1.636-.499-2.913-.558C15.667.015 15.26 0 12 0z" />
                                </svg>
                                IG: azzamilschool
                            </a> <br />
                            <a href="https://www.instagram.com/azzamilschoolpml?igsh=MWs1OXpkcXh5ZHI1Zg=="
                                target="_blank" class="inline-flex items-center gap-1 hover:text-tealBtn transition">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.117.63c-.79.297-1.427.645-2.058 1.276-.63.63-.979 1.268-1.276 2.058-.297.79-.5 1.659-.56 2.948C.031 8.333 0 8.74 0 12c0 3.26.015 3.667.072 4.947.06 1.277.261 2.148.558 2.913.297.788.645 1.426 1.276 2.058.63.63 1.268.978 2.058 1.276.765.297 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24c3.26 0 3.667-.015 4.947-.072 1.277-.059 2.148-.261 2.913-.558.788-.298 1.426-.646 2.058-1.276.63-.63.979-1.268 1.276-2.058.297-.765.499-1.636.558-2.913.037-1.28.073-1.689.073-4.948 0-3.259-.015-3.667-.072-4.947-.06-1.277-.261-2.148-.558-2.913-.297-.789-.645-1.427-1.276-2.058-.63-.63-1.268-.979-2.058-1.276-.765-.297-1.636-.499-2.913-.558C15.667.015 15.26 0 12 0z" />
                                </svg>
                            ...
                            <a href="https://youtube.com/@azzamilschool5740?si=1KLYpIVuzSL0WjYi" target="_blank"
                                class="inline-flex items-center gap-1 hover:text-tealBtn transition">
                                <svg class="w-3.5 h-3.5 text-[#333]" fill="currentColor" viewBox="0 0 24 24">
                                    <path
